...
def Create_Material_Data(model, material_name, e11, e22, e33, nu12, nu13, nu23, g12, g13, g23, lts, lcs, tts, tcs, lss,
                         tss):
...
def Create_Boundary_Condition_by_Instance(model, instance_name, set_name, BC_name, step_name, u1_BC, u2_BC, u3_BC,
...
Create_Material_Data(myString, "CFRP", myE11, myE22, myE33, myNu12, myNu13, myNu23, myG12, myG13, myG23, myLTS, myLCS,
...
Create_Analysis_Step(myString, Create_Boundary_Condition_by_Instance(myString, "Cylinder-1", "Set-RP-2", "BC-Set-RP-2", "Initial", SET, SET, SET,
                                      UNSET, UNSET, UNSET)
Create_Boundary_Condition_by_RP(myString, "RP-1", "Displacement_Load", "Step-1", UNSET, UNSET, 20, UNSET, UNSET, UNSET)
"Step-1", "Initial", 0.01, 0.01, 1E-015, 300, ON)

Create_Boundary_Condition_by_Instance(myString, "Cylinder-1", "Set-RP-1", "BC-Set-RP-1", "Initial", SET, SET, UNSET,
                                      UNSET, UNSET, UNSET)
